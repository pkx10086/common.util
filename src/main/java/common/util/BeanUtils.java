...
public class BeanUtils {
    ...
    private static final String ANNOTATION_AUTHOR_NAME = "pkx";
    ...
    private static final String DAO_PATH = "com/pkx/base/dao";
    private static final String DAO_IMPL_PATH = "com/pkx/base/dao/impl";
    private static final String SERVICE_PATH = "com/pkx/base/service";
    private static final String SERVICE_IMPL_PATH = "com/pkx/base/service/impl";

    
    
    //包名
    private static final String BEAN_URL = "com.pkx.base.bean";
    private static final String DAO_URL = "com.pkx.base.dao";
    private static final String DAO_IMPL_URL = "com.pkx.base.dao.impl";
    private static final String SERVICE_URL = "com.pkx.base.service";
    private static final String SERVICE_IMPL_URL = "com.pkx.base.service.impl";
